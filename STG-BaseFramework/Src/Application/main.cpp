...
bool Application::Init(int w, int h)
{
	...
	// ウィンドウ作成
	//===================================================================
	if (m_window.Create(w, h, "Ray Seeker | FPS : [--]", "Window") == false) {
...
void Application::Execute()
{
	...
	while (1)
	{
		...
		// バックバッファクリア
		D3D.GetDevContext()->ClearRenderTargetView(D3D.GetBackBuffer(), Math::Color(0.00f, 0.28f, 0.58f, 1));
		// Zバッファクリア
		...
		std::string titleBar = "Ray Seeker | FPS [" + std::to_string(m_fps) + "]";
